...
import (
	"github.com/palantir/godel-okgo-asset-errcheck/generated_src/internal/amalgomated_flag"
	"fmt"
	"os"
	"path/filepath"
	"regexp"
	...
	"github.com/palantir/godel-okgo-asset-errcheck/generated_src/internal/github.com/kisielk/errcheck/errcheck"
